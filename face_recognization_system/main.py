...
class FaceRecognitionSystem:
    def __init__(self, root):
        ...
        # Image paths
        image_paths = {
            "main": 'E:\\face_recognization_system\\college_images\\stanford.jpeg',
            "banner": 'E:\\face_recognization_system\\college_images\\stanford3.jpeg',
            "button": 'E:\\face_recognization_system\\college_images\\stanford2.jpeg'
        }
    ...
    def open_student_details(self):
        self.run_script('E:\\face_recognization_system\\student.py')

    def open_face_detector(self):
        self.run_script('E:\\face_recognization_system\\recognizer.py')

    def open_attendance(self):
        self.run_script('E:\\face_recognization_system\\attendance.py')

    def open_attendance_sheet(self):
        self.run_script('E:\\face_recognization_system\\sheet.py')

    def open_train_data(self):
        self.run_script('E:\\face_recognization_system\\phototrain.py')
